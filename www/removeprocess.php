...
$error="Remove server from process";
session_start();
...
$sql="delete from process where hostname ='".$hostname."';";
if ($link->query($sql) === TRUE) {
			echo "Record deleted successfully";
			$_SESSION['error'] = $hostname." deleted from process table";
		} else {
...
<html>
   ...
   <head>
      <title>Remove from process</title>
      <meta charset="UTF-8">
      <style type = "text/css">
         body {
   ...
   include('servicemenu.php');   ?>
      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b>Remove from Process</b></div>
